...
CASES = (
    ...
    _Case("chat-turn", "chat.turn", "recipe", "recipe-matrix"),  # HS-150-02: was recipe.chat
...
@pytest.mark.parametrize(
    ...
    (
        ...
        _Case("contextual-chat-turn", "chat.turn", "recipe", "recipe-matrix"),  # HS-150-02: was recipe.chat
...
ENTRY_CASES: tuple[tuple[str, str, Callable[[Database, Any], Any]], ...] = (
    ...
    # HS-150-02: recipe.chat retired — both _run_recipe_chat_* helpers call
    # RecipeService.chat() which internally admits "recipe.chat", no longer in
    # the sealed registry. Removed until HS-150-04 re-wires the alias.

...
class MCPClient:
    ...
    def start(self) -> None:
        ...
        # PHILO-5-01: the production sidecar is a proxy only. The walk server
        # (tests/integration/_mcp_walk_server.py) composes the service layer
        # in its own process over this isolated HOME. (A hub-proxied walk is
        # covered by

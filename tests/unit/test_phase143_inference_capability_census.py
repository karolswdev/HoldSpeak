...
holdspeak/intel/engine.py:303|MeetingIntel._chat_completion_text|create_chat_completion|call
holdspeak/intel/engine.py:340|MeetingIntel._chat_completion_text|_remote_completion|call
holdspeak/intel/engine.py:340|MeetingIntel._chat_completion_text|chat.completions.create|ref
holdspeak/intel/engine.py:384|MeetingIntel._chat_completion_stream|create_chat_completion|call
holdspeak/intel/engine.py:422|MeetingIntel._chat_completion_stream|_remote_completion|call
holdspeak/intel/engine.py:422|MeetingIntel._chat_completion_stream|chat.completions.create|ref
holdspeak/intel/engine.py:500|MeetingIntel._chat_completion_deltas|create_chat_completion|call
holdspeak/intel/engine.py:591|MeetingIntel._chat_completion_deltas|_remote_completion|call
holdspeak/intel/engine.py:592|MeetingIntel._chat_completion_deltas|chat.completions.create|ref
holdspeak/intel/engine.py:703|MeetingIntel.run_prompt_stream|_chat_completion_deltas|call
holdspeak/intel/engine.py:744|MeetingIntel.run_prompt|_chat_completion_text|call
holdspeak/intel/engine.py:773|MeetingIntel.run_prompt_messages|_chat_completion_text|call
holdspeak/intel/engine.py:787|MeetingIntel._analyze_once|_chat_completion_text|call
holdspeak/intel/engine.py:862|MeetingIntel._analyze_stream|_chat_completion_stream|call
holdspeak/intel/engine.py:931|MeetingIntel.generate_title|_chat_completion_text|call
holdspeak/intel/engine.py:1006|MeetingIntel.generate_bookmark_label_with_context|_chat_completion_text|call

...
holdspeak/intel_queue.py:682|process_next_intel_job|analyze|call
...
PRODUCT_RUNNER_ENTRANCES: dict[str, ProposedRoute] = {
    ...
    "holdspeak/services/inference_adoption_service.py:1288|RoutedInferenceCoordinator.execute|call": ProposedRoute(

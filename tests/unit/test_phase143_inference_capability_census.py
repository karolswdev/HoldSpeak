...
holdspeak/intel/engine.py:516|MeetingIntel.run_prompt|_chat_completion_text|call
holdspeak/intel/engine.py:544|MeetingIntel.run_prompt_messages|_chat_completion_text|call
holdspeak/intel/engine.py:558|MeetingIntel._analyze_once|_chat_completion_text|call
holdspeak/intel/engine.py:634|MeetingIntel._analyze_stream|_chat_completion_stream|call
holdspeak/intel/engine.py:704|MeetingIntel.generate_title|_chat_completion_text|call
holdspeak/intel/engine.py:779|MeetingIntel.generate_bookmark_label_with_context|_chat_completion_text|call
...
SEMANTIC_HELPER_CALLERS: dict[str, ProposedRoute] = {
    ...
    "holdspeak/mcp/tools.py:645|dispatch|chat": ProposedRoute(

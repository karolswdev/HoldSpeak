...
WEB_ROUTING_SURFACES: dict[str, tuple[str, str]] = {
    ...
    # S4 removed every Thought/Dictation caller. Its three surviving Recipe/
    # Workbench callers are the explicitly deferred S5 replacement.
    "web/src/desk/components/RunsOnPicker.tsx": ("inference-route", "143-10"),

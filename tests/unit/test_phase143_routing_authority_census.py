...
ROUTING_POINTER_ATTRIBUTES = {
    ...
    "holdspeak/services/inference_setup_service.py:643:intel_profile_id",
    "holdspeak/services/inference_setup_service.py:648:inference_target_id",
    "holdspeak/services/inference_setup_service.py:649:inference_target_id",
    "holdspeak/services/inference_setup_service.py:653:intel_profile_id",
...
PROFILE_ID_CLASSIFICATIONS = {
    ...
    **{site: "display" for site in {
        ...
        "holdspeak/services/inference_setup_service.py:652:profile_id", "holdspeak/services/settings_service.py:99:profile_id",

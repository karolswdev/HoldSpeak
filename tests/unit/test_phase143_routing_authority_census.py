...
ROUTING_POINTER_ATTRIBUTES = {
    ...
    "holdspeak/db/models/__init__.py:1112:resolver_profile_id",
...
PROFILE_ID_CLASSIFICATIONS = {
    **{site: "mutable assignment pointer" for site in {
        ...
        "holdspeak/db/models/__init__.py:1111:profile_id",
    }},
    **{site: "display" for site in {
        ...
        "holdspeak/db/models/__init__.py:673:profile_id", "holdspeak/inference_targets.py:161:profile_id",

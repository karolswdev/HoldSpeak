...
ROUTING_RESOLVER_REFERENCES = {
    ...
    "holdspeak/kernel/projection_stager.py:168:import:resolve_workbench_deployment_revision",
    "holdspeak/kernel/projection_stager.py:169:ref:resolve_workbench_deployment_revision",
...
ROUTING_POINTER_ATTRIBUTES = {
    ...
    "holdspeak/db/models/__init__.py:1117:resolver_profile_id",
...
PROFILE_ID_CLASSIFICATIONS = {
    **{site: "mutable assignment pointer" for site in {
        ...
        "holdspeak/db/models/__init__.py:1116:profile_id",
    }},
    **{site: "display" for site in {
        ...
        "holdspeak/db/models/__init__.py:678:profile_id", "holdspeak/inference_targets.py:161:profile_id",

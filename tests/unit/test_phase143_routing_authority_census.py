...
ROUTING_RESOLVER_REFERENCES = {
    ...
    "holdspeak/kernel/inference_runner.py:844:ref:resolve_deployment_revision",
...
PROFILE_ID_CLASSIFICATIONS = {
    ...
    **{site: "display" for site in {
        ...
        "holdspeak/db/models/__init__.py:685:profile_id", "holdspeak/inference_targets.py:161:profile_id",
    ...
    **{site: "migration source" for site in {
        "holdspeak/db/models/__init__.py:1123:profile_id",

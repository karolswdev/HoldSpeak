...
SURFACE_DRIVERS: dict[str, Callable[[Any, Any], SurfaceRun]] = {
    ...
    # HS-150-02: "Recipe chat" removed — recipe.chat retired from registry;
    # RecipeService.chat() unavailable until HS-150-04 rewires the alias.
...
assert len(SURFACE_DRIVERS) == 15, "every named surface form is proven here; none may be collapsed (HS-150-02: Recipe chat retired)"
...
ROOT_SHAPED_SURFACES = frozenset({"Ask", "Recipe run"})  # HS-150-02: Recipe chat removed

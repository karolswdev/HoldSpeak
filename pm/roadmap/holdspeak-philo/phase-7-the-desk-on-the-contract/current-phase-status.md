...
**Last updated:** 2026-09-25 (RATIFIED by the owner — "Ratify, build it"; R5: `decision.delete` IS in the delegation grant. Lanes open: 01 first. Earlier: DRAFTED r4 — Astra's r3 check RATIFY-WITH-CONDITIONS paid: refusal coverage at the adapters; the grant lifecycle design beat carried into story 02 as a precondition; the face verb scoped to filing and decisions; the D4 claim qualified in the pointers. The owner's ratification of the charter owed).

...
**Last updated:** 2026-09-25 (PHILO-7-01 built on `feat/philo-7-01-notes-directories`: fifteen descriptors, the rename repair, discovery words, the shelf alignment; residual 320 -> 293 (MCP 256 -> 232, HTTP 64 -> 61); calibration recorded under "Where we are". Astra's check on built owed. Earlier: DRAFTED r4, then ratified by the owner 2026-09-25).

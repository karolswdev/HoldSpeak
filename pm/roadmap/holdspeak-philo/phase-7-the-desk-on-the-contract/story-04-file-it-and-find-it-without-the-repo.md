...
- [x] Technical rehearsal completes with the other brain's check recorded (the roles swapped on 2026-09-25: the lane was Muad'Dib's; the check is the Astra-role check, `checks/story-04-built-astra-role-r1.md`, RATIFY-WITH-CONDITIONS, paid); the evidence reads "REHEARSED; OWNER-REVIEWED", never an observed sitting. The Astra-role checker is an Opus 5.5 stand-in (the owner's ruling, 2026-09-25), the same model family as the lane.

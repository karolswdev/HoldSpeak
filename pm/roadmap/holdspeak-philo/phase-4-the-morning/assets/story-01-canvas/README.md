...
**Status: UNRATIFIED, round five.** Astra checked round one and bounced it (six findings); round two paid them. Astra checked round two: RATIFY-WITH-CONDITIONS (four conditions); round three paid them. Astra checked round three: canvas RATIFY-WITH-CONDITIONS, library BOUNCE. Round four pays both. Round five puts the day-one rows in the producer's order and gives route chips their destination as a title. The owner has not seen these boards. Build nothing until he ratifies them (UX-CANON A.2).

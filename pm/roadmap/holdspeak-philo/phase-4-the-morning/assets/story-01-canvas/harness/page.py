...
H1 = "<h1>PHILO-4-01 · THE BRIEF SECTION · GENERATE ALWAYS REACHABLE · WITH PHILO-4-02 ROW ORDER · ROUND FOUR</h1>\n"
BOARDS = [
 ("0-today", "0 · TODAY (REFERENCE)", "the face on main, 12 px library · no Generate while a row is untriaged · the decision is behind 1 more"),
 ("1-generate-reachable", "1 · GENERATE IS REACHABLE", "proposed · THIS DEVICE + Generate in the head · the decision row leads · at 393 the label wraps, the verb keeps its width"),
 ...
 ("4-next-day-one-decision", "4 · NEXT DAY, ONE GENERATE", "proposed · the new decision is row 1 · caption and badge unchanged · 3 more = 6 − 3"),
 ("5-next-day-several-decisions", "5 · NEXT DAY, SEVERAL DECISIONS", "proposed · newest first (illustrated created_at SEP 24 07:58 · SEP 23 16:10 · SEP 22 11:30) · 4 more = 7 − 3"),
 ...
 ("7b-fully-triaged", "7B · FULLY TRIAGED", "a populated brief, every row Ack or Defer · the rows leave the Arrival · head BRIEF · the stored headline, from the real _compose: 1 thing changed, 1 thing waiting, 2 decisions waiting. · it still counts the four items (story 04) · Generate (today: Generate again)"),
...
LIBS = [
 ...
 ("lib-route-fallback-393", "LIBRARY · ROUTE FALLBACK AT 393", "the real RouteDisclosure · a route chip keeps its full text: + FALLBACK API.ANTHROPIC.COM · no horizontal overflow"),
]

...
H1 = "<h1>PHILO-4-01 · THE BRIEF SECTION · GENERATE ALWAYS REACHABLE · WITH PHILO-4-02 ROW ORDER · ROUND THREE</h1>\n"
BOARDS = [
 ...
 ("7b-fully-triaged", "7B · FULLY TRIAGED", "a populated brief, every row Ack or Defer · the rows leave the Arrival · head BRIEF · the stored headline still counts the four items · Generate (today: Generate again)"),
...
LIBS = [
 ...
 ("lib-jira-chip-393", "LIBRARY · JIRA CHIP AT 393", "the real ConnectionsPane Jira row · the host chip truncates at 32ch · Recheck keeps its width and its word"),
]

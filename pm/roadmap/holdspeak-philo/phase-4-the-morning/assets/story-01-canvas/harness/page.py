...
H1 = "<h1>PHILO-4-01 · THE BRIEF SECTION · GENERATE ALWAYS REACHABLE · WITH PHILO-4-02 ROW ORDER · ROUND TWO (12 PX FLOOR)</h1>\n"
BOARDS = [
 ...
 ("6-null-brief", "6 · NO BRIEF YET", "proposed · No brief yet (A3) + Generate in the head · busy/failure/result as 3c, 3a, 4"),
 ("7-nothing-untriaged", "7 · NOTHING UNTRIAGED", "proposed · every row triaged · Generate (today: Generate again) · busy/failure/result as 2a, 3a, 4"),
]

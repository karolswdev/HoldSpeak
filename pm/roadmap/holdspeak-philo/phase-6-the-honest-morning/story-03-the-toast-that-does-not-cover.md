...
- 2026-09-24 night — Muad'Dib's counsel on built: RATIFY-WITH-CONDITIONS; conditions paid in the reconcile commit ([check](./checks/story-03-placement-built-muaddib.md)). After the merge of main `e64114df` the Arrival slot is at `ChairHome.tsx:1450-1453`.

...
**Last updated:** 2026-09-26 (PHILO-8-03 BUILT, in progress — `atlas-phase8.json`: 14 face cases and 5 `.op`, red on main, green on the #672 build; the closing rehearsal at 1440 and 393 for the owner's review; `final-summary.md` drafted, the CLOSED line waits on his word. Earlier: PHILO-8-01 DONE — the list's in-row zone name field, the NAME TAKEN chip on the list and the Floor, F2 on zone rows, on the owner's canvas ratification. Earlier: PHILO-8-01 half A built — the free zone name ("New zone 2"), the Chair without New Zone, no stale rename field; the list's in-row name field on the canvas for the owner. Earlier: PHILO-8-04 (a) DONE: the decision window shows no heading with nothing under it, at 1440 and 393; (b) dropped by the owner. Earlier: Phase 8 The Honest Floor DRAFTED on the owner's word closing Phase 7 ("Close, and make the Floor Phase 8"): the four verified Floor defects, three stories and one optional; the Astra-role check RATIFY-WITH-CONDITIONS, C1–C9 paid in round two; the owner's ratification owed. Earlier: Phase 7 CLOSED on the owner's word: `final-summary.md` written — exits 2, 3, 6 MET; 1, 4, 5 MET WITH QUALIFICATION; the ledger ranked by owner cost. Earlier: PHILO-7-04 DONE: the owner reviewed the cold-context Claude rerun — "Reviewed — it's right"; the Astra-role check paid. Earlier (2026-09-25): PHILO-7-04 rehearsed by a cold-context Claude session (R6, "Claude closes it"), rerun after the owner's review ("the decision is thin"): both legs complete, zero repository reads, the decision's reason on the face at 1440 and 393. Earlier: PHILO-7-03 built: the atlas for the desk — 27 new cases in `atlas-phase7.json`, the rig's receipt reads and carriage repairs; one face finding (the delete receipt above the top edge). Earlier: PHILO-7-02 round two paid (Astra's check on built, BOUNCE): the grant body P0, receipts in every refusal response, the scroll edge. Earlier: PHILO-7-02 built on `feat/philo-7-02-article-xi`: membership and decisions under Article XI, the delegation grant and its ratified face; residual 293 -> 284. Earlier: PHILO-7-01 built and round two paid after Astra's check on built (RATIFY-WITH-CONDITIONS): notes, zones and knowledge bases on the contract; the rename repair; discovery words; the shelf alignment; residual 320 -> 293. Earlier: Phase 7 RATIFIED; R5 decision.delete in the grant).

## Vision

Make HoldSpeak understandable through verified capabilities and precise Desk contracts.
This is a documentation initiative within HoldSpeak, not another product or runtime.
It does not replace the active HoldSpeak Phase 201 pointer.

## Source canon

- [Constitution](../../../docs/internal/CONSTITUTION.md), Seven Tenets first.
...
| 7 | The Desk on the Contract — the bounded desk slice (notes, zones, knowledge bases, membership, the remaining decision operations: 33 MCP + 3 HTTP identities) on the one contract; filing and deciding admitted through the kernel (D3); file and find from a cold-context Codex session (D4 as R3 qualifies it: cold context, zero repository reads in the retained log, discovery from the catalogue alone; not a filesystem sandbox) | CLOSED 2026-09-26 on the owner's word ("Close, and make the Floor Phase 8"); rehearsed, owner-reviewed — [final summary](phase-7-the-desk-on-the-contract/final-summary.md) | [Phase 7](phase-7-the-desk-on-the-contract/current-phase-status.md) |
| 8 | The Honest Floor — the four verified Floor defects, repaired with existing idioms: a second unnamed zone no longer fails 409; the rename opens where he is (Chair and list, canvas first); the list-view Delete deletes with the same undo receipt; two deletes in one undo window both happen | RATIFIED 2026-09-26 ("Ratify, build it"; Q1 (a), Q2 (c), Q3 keep (a)); in build | [Phase 8](phase-8-the-honest-floor/current-phase-status.md) |

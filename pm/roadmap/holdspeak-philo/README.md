...
**Last updated:** 2026-09-24 (Phase 5 The One Service Layer chartered; the owner's ratification owed).
...
| 5 | The One Service Layer — one application-operation contract; routes, MCP and the rig over it; the Phase 3+4 loop as pilot | chartered 2026-09-24, the owner's ratification owed | [Phase 5](phase-5-the-one-service-layer/current-phase-status.md) |

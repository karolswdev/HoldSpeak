...
| 4 | The Morning — the next-day brief in one move: Generate always reachable, the new decision in the visible rows, no id collision | RATIFIED 2026-09-23; in build | [Phase 4](phase-4-the-morning/current-phase-status.md) |

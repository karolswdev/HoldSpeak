...
- [ ] (a, if kept) A decision with an empty context, decision or consequences field shows no heading for that field; with text, the heading and text show; at 1440 and 393. Red on main.

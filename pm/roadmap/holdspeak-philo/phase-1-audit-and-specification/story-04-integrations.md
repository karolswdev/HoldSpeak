# PHILO-1-04 — Agents, integrations, companions and knowledge
...
Agents, integrations, companions and knowledge, with evidence pinned to the research snapshot.
...
The eight guides distinguish session observation, response delivery, tool
authority, external effects and companion clients. Root corrected Gate preview
claims against the implementation and a synthetic-marker probe. The independent
accuracy review ratifies that correction. Hardware, provider delivery and public
release remain explicit limits. Eight-document navigation passed; final diagram
validation is captured with story 07.

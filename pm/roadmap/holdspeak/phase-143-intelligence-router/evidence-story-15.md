# Evidence - HSEGHS001HS104-143-15

- **Story:** HSEGHS001HS104-143-15 - Intelligence Router Repo-Wide Documentation
- **Status:** done
- **Date:** 2026-08-26

## Proof

### Captured run — 2026-08-27T00:43:35Z
...
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** b78c338b0c1c2a3f0658327f5697b0751c55d1f8
...
___ test_workbench_deadline_expiry_fences_new_children_and_late_projections ____
[gw9] darwin -- Python 3.13.11 /Users/karol/dev/tools/HoldSpeak/.venv/bin/python3

tmp_path = PosixPath('/private/var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/pytest-of-karol/pytest-3087/popen-gw9/test_workbench_deadline_expiry0')
monkeypatch = <_pytest.monkeypatch.MonkeyPatch object at 0x113581b00>
...
E            +    where wait = <threading.Event at 0x1145e53d0: unset>.wait

tests/unit/test_workbench_runner_migration.py:384: AssertionError
...
SKIPPED [1] tests/integration/test_dictation_llama_cpp_e2e.py:72: llama-cpp-python and /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.25e704JA5L/xdist-gw1/Models/gguf/Qwen3.5-4B-Instruct-Q4_K_M.gguf are required for this integration test
...
SKIPPED [1] tests/integration/test_runtime_llama_cpp.py:38: llama-cpp-python and /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.25e704JA5L/xdist-gw2/Models/gguf/Qwen3.5-4B-Instruct-Q4_K_M.gguf are required for this integration test
SKIPPED [1] tests/integration/test_runtime_mlx.py:38: mlx-lm + outlines + /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.25e704JA5L/xdist-gw2/Models/mlx/Qwen3.5-8B-MLX-4bit are required for this integration test
...
FAILED tests/unit/test_workbench_runner_migration.py::test_workbench_deadline_expiry_fences_new_children_and_late_projections
14 failed, 6674 passed, 53 skipped in 494.19s (0:08:14)
```

## Orchestrator triage note (2026-08-27)

Docs-only story; the captured run exits 1 lawfully. 11 of 14 FAILED
names are the inherited baseline; the three non-baseline names are all
known flake families, none touched by this diff: the assignments
overview glass pair (the 393 leg is Story 14's named ready-barrier
intake; the 1440 leg is its ordinary serial-green sibling) and the
workbench deadline-expiry xdist family. Pre-capture sweep triage was
identical in kind (sigkill kernel replay serial-green ×3, refinement
serial-green). ZERO real branch-new — expected: the diff is
docs/internal/, docs/, README, one generator template, and PMO files.
The acceptance-critical proof is in the story record: the Recipe-run
trace was verified step-by-step against shipped modules (worker
file:line log + orchestrator spot-checks), the stale-vocabulary sweep
is clean, and all six entry points defer to the canonical doc.

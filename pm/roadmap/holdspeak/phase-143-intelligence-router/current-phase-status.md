...
(two recurring xdist load flakes, each serial-green twice). Next: C1
checkpoint round 4 (Sol probes the lease), then C2 (plugins) and C3
(the Stop-handoff provider — the ratified primitive's first real
adopter).
Verification ledger:

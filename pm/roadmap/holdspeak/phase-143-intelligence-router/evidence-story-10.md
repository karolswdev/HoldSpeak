# Evidence - HSEGHS001HS104-143-10

- **Story:** HSEGHS001HS104-143-10 - Agents Workbenches and Recipes Adoption
- **Status:** done
- **Date:** 2026-08-25

## Proof

### Captured run — 2026-08-26T02:31:26Z
...
- **Cwd:** .
- **Exit code:** 1
- **Index-tree:** e8658f5807528a3734cc5fe2538d069af0143afc
...
E           web/src/pages/cores/InferenceCapabilityPanel.tsx:163: failure-missing-facts: Models couldn’t load.
...
SKIPPED [1] tests/integration/test_dictation_llama_cpp_e2e.py:72: llama-cpp-python and /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.1FunGLY6hO/xdist-gw1/Models/gguf/Qwen3.5-4B-Instruct-Q4_K_M.gguf are required for this integration test
...
SKIPPED [1] tests/integration/test_runtime_llama_cpp.py:38: llama-cpp-python and /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.1FunGLY6hO/xdist-gw2/Models/gguf/Qwen3.5-4B-Instruct-Q4_K_M.gguf are required for this integration test
SKIPPED [1] tests/integration/test_runtime_mlx.py:38: mlx-lm + outlines + /var/folders/q7/5dzz5g2116b3lq8rhg7hwjrr0000gn/T/tmp.1FunGLY6hO/xdist-gw2/Models/mlx/Qwen3.5-8B-MLX-4bit are required for this integration test
...
12 failed, 6601 passed, 53 skipped in 464.82s (0:07:44)
```
...
main reproduces them) — **ZERO branch-new**. Three sweeps ran this
story: №1 (6574/39: 34 inherited + 1 census xdist flake serial-green ×2
+ 4 real branch-new → fixed in commit b974377b), №2 (6601/12, zero
branch-new), and this captured №3 (6601/12, identical set). The branch
HEALS ~22 previously-inherited failures (34 reproduced in sweep №1,
12 remain). Story bar: two opus gate audits (Slices 1–3; Slices 4+6 +
story acceptance) both CLEAN with zero findings. Criterion 6
(Apple/Swift) is out of this story's bar by owner ruling — the Slice-5
progress is frozen compile-green on `hold/hs143-10-slice5-swift-bridge`;
the seven Swift leaves remain censused HELD.

...
**Status:** scaffolded (0/4). Opened 2026-06-11 on user direction ("K, then
...
**Last updated:** 2026-06-11 (scaffolded — seams verified: neither Whisper
...
|---|---|---|---|
| HS-59-01 | The language knob, end to end | backlog | none |
...
Scaffolded. Next is **HS-59-01 — the language knob**: config → both
backends → all four construction sites → settings, "auto" byte-identical.

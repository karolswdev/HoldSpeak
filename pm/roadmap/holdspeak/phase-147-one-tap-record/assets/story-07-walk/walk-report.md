...
|---|---|---|---|
| cold | PASS | 1876.400 ms | First Sentence container; First Sentence editable pad |
| reveal | PASS | — | .door-board-section; .door-board-section > .door-board-column heading Active |
| completion | PASS | 42.000 ms | .door-board-section .door-board-receipt; GET /api/door after Door action |
...
- PASS — **typed first value reaches visible Desk result and custody within 3 minutes**. Scope: First Sentence real Continue later handoff. first_value_mode=typed_fallback elapsed_ms=1876.400
...
- PASS — **Done changes its owning Overdue column within 500ms**. Scope: Overdue Door card detachment measured by page performance.now(). completion_ms=42.000
- PASS — **read active Thought for stale-refusal setup**. Scope: production HTTP authority GET /api/thoughts/thought_fcf96ace951c. status=200 payload={'thought': {'id': 'thought_fcf96ace951c', 'raw_id': 'thought_fcf96ace951c', 'raw_sha256': 'c3ef1083d1e712832249d018d4f85bd872a336c423f4497ae738659381bec4de', 'source': {'kind': 'typed'}, 'raw_captured_at': '2026-08-29T0
- PASS — **drift active Thought through custody authority**. Scope: production HTTP authority PATCH /api/thoughts/thought_fcf96ace951c/working. status=200 payload={'thought': {'id': 'thought_fcf96ace951c', 'raw_id': 'thought_fcf96ace951c', 'raw_sha256': 'c3ef1083d1e712832249d018d4f85bd872a336c423f4497ae738659381bec4de', 'source': {'kind': 'typed'}, 'raw_captured_at': '2026-08-29T0
...
- PASS — **Door aggregate contains actual fixture calendar source**. Scope: GET /api/door upcoming. [{'id': 'sr_d8ccb8b82b14', 'source': 'scheduled_recording', 'target_ref': 'scheduled_recording:sr_d8ccb8b82b14', 'title': 'HS144 WALK baseline recording', 'starts_at': '2026-08-29T09:00:00Z', 'ends_at': '2026-08-29T09:30:00Z', 'location': None, 'meeting_url': None, 'state': 'idle'}, {'id': 'ce_16daca1f552ae8279bf0c6173de8efefe3c9e5ba2436e078799d652e590888af', 'source': 'calendar_event', 'target_ref': 'calendar_event:ce_16daca1f552ae8279bf0c6173de8efefe3c9e5ba2436e078799d652e590888af', 'title': 'HS144 WALK calendar fixture', 'starts_at': '2026-08-29T09:01:00Z', 'ends_at': '2026-08-29T09:46:00Z', 'location': 'Walk Room 4', 'meeting_url': 'https://meet.example.test/hs144-walk', 'state': 'scheduled', 'source_id': 'walk-file', 'source_label': 'Walk File'}, {'id': 'sr_d724232b484d', 'source': 'scheduled_recording', 'target_ref': 'scheduled_recording:sr_d724232b484d', 'title': 'HS144 WALK in-world recording', 'starts_at': '2027-08-29T01:31:00Z', 'ends_at': '2027-08-29T02:31:00Z', 'location': None, 'meeting_url': None, 'state': 'idle'}]
...
- PASS — **one tap arms a linked enabled one-shot**. Scope: POST via door-record-this + GET /api/scheduled-recordings. [{'id': 'sr_d7a3ee97080f', 'title': 'HS144 WALK one-tap standup', 'cron_expr': '0 0 1 1 *', 'tz': 'MDT', 'one_shot': True, 'duration_minutes': 45, 'enabled': True, 'revision': 1, 'created_at': '2026-08-29T07:01:38Z', 'last_fired_at': None, 'next_fire_at': '2026-08-29T09:00:00Z', 'armed_at': None, 'deadline_at': None, 'state': 'idle', 'last_outcome': '', 'last_receipt_id': '', 'delegation_receipt_id': 'sr_rcpt_639ce242aa5c', 'calendar_event_id': 'ce_ebdc4f32ec1e12d34001bbd0417764f7cfb2c3b42f79d0515160580a6bee9232', 'calendar_uid': 'hs147-walk-a', 'calendar_source_id': 'walk-one-tap'}]
- PASS — **armed fire time carries the 60s lead**. Scope: 60s-lead ruling (D4). next_fire_at=2026-08-29T09:00:00Z expected_epoch=1787994000.0
...
- PASS — **synced linked meeting keeps calendar_event_id (round-trip law)**. Scope: POST /api/sync/push + GET /api/meetings. [{'id': 'hs147-walk-linked-meeting', 'started_at': '2026-08-29T06:01:38.335459', 'ended_at': '2026-08-29T06:46:38.335459', 'title': 'HS144 WALK one-tap review', 'duration_seconds': 2700, 'segment_count': 0, 'action_item_count': 0, 'tags': [], 'intel_status': 'disabled', 'intel_status_detail': None, 'capture_status': 'finalized', 'capture_failure': None, 'capture_checkpoint_seconds': 0, 'provenance': 'native', 'calendar_event_id': 'ce_2d4c6e5281117c36d9543728e3e9c8261fee78191ebfd67ec8e4574441f22aef', 'calendar_event_title': 'HS144 WALK one-tap review', 'calendar_source_label': 'Walk Tap'}]
...
- Shots: `pm/roadmap/holdspeak/phase-147-one-tap-record/assets/story-07-walk/shots/`
- Machine JSON: `pm/roadmap/holdspeak/phase-147-one-tap-record/assets/story-07-walk/walk-report.json`
- Pair manifest: `pm/roadmap/holdspeak/phase-147-one-tap-record/assets/story-07-walk/walk-pairs.json` and `pm/roadmap/holdspeak/phase-147-one-tap-record/assets/story-07-walk/walk-pairs.md`
...
- stopped hub pid=9654 exit=0
- deleted ICS fixture tree: /private/tmp/claude-501/-Users-karol-dev-tools-HoldSpeak/5ce49957-4ec2-4c69-803c-324206b30a97/scratchpad/walk-debug/tmp/hs144-door-walk-8v6jeyz7/fixtures
- deleted walk HOME/XDG/TMP tree: /private/tmp/claude-501/-Users-karol-dev-tools-HoldSpeak/5ce49957-4ec2-4c69-803c-324206b30a97/scratchpad/walk-debug/tmp/hs144-door-walk-8v6jeyz7
- cleanup=pass

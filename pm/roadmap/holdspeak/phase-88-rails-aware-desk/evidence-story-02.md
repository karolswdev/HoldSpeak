...
- **Story:** HS-88-02 - The grounding picker learns the rails
- **Status:** done
- **Date:** 2026-07-08

## Proof

### Captured run — 2026-07-08T10:29:11Z

- **Command:** `uv run pytest -q tests/unit/test_web_routes_missioncontrol.py tests/integration/test_grounding_rails_live.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 6bbb9cf75f528834a81ef42ee72f457c6a9d0923
...
### Captured run — 2026-07-08T10:29:14Z
...
```text
 ...
 Test Files  7 passed (7)
      Tests  97 passed (97)
   Start at  04:29:15
   Duration  233ms (transform 712ms, setup 0ms, import 816ms, tests 68ms, environment 0ms)
```

### Captured run — 2026-07-08T10:29:15Z
...
3427 passed, 37 skipped in 270.25s (0:04:30)
```

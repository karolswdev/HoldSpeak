...
- [ ] Every hand-rolled block the 01 audit named in these files is gone; the CSS classes it owned are deleted (no dead style).
- [ ] The 158/159/161 glass rigs and their vitest pass unchanged in assertion (behavior identical); web baseline zero branch-new.
- [ ] Shots match the mockups at both widths; the gallery carries before/after; the orchestrator read every PNG.

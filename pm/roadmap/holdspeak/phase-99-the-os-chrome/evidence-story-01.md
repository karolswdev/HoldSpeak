...
- **Story:** HS-99-01 - The study and the tokens
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T04:23:17Z

- **Command:** `bash -c cd web && npm run check`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9a2ca89734ef4eebcac1f6e9165e9479ea65a61c
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  22:23:21
   Duration  10.32s (transform 789ms, setup 1.39s, import 3.63s, tests 2.99s, environment 8.97s)
...
### Captured run — 2026-07-19T04:23:36Z
...
........................................................................ [ 50%]
.......................................................................  [100%]
143 passed, 3065 deselected in 2.72s
```

## Summary of proof

- **The study is canon:** `docs/internal/PROZILLAOS_STUDY.md` — MIT
  attribution, the borrow table (each technique naming its landing
  story), the embrace list (our floors that beat the reference and
  must not regress), the skip list with reasons, and the concrete
  numbers worth keeping.
- **The tokens:** nine component tokens — the tonal ladder
  (`--desk-window-head-fill` / `--desk-window-rail` /
  `--desk-window-well` around the existing body fill), the scrollbar
  thumb pair, `--desk-control-h`, and the easing family
  (`--ease-quart/expo/back`). Generated CSS/TS in sync; token gate
  clean with no new allow-list entries (63, all in use).
- **Spec first:** DESIGN_SYSTEM.md gains "The chrome ladder (HS-99)"
  — seven rules in token vocabulary, each naming its landing story —
  BEFORE any chrome story consumes them.
- **Suites:** captured `npm run check` green (289 web tests) and the
  doc/design/guard subset green.

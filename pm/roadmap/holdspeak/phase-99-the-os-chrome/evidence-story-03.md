...
- **Story:** HS-99-03 - Controls wear the skin
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T04:37:08Z

- **Command:** `bash -c cd web && npm run check`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9c9feebcd53b793be1245e7b869b89afbf8dd7ac
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  22:37:13
   Duration  10.35s (transform 809ms, setup 1.42s, import 3.62s, tests 2.98s, environment 8.96s)
...
../holdspeak/static/_built/assets/index-CBHl-SiZ.css                                   99.43 kB │ gzip:  32.21 kB
../holdspeak/static/_built/assets/webworkerAll-B0USg4Fq.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-BWgWzXtV.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-DbsAzV14.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-D0WFnVxt.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-BGmQGJ-g.js                                0.99 kB │ gzip:   0.59 kB │ map:     2.65 kB
../holdspeak/static/_built/assets/pageSupport-dkHgry9D.js                               1.01 kB │ gzip:   0.61 kB │ map:     5.63 kB
../holdspeak/static/_built/assets/CompanionCore-DD3uBDOu.js                             1.81 kB │ gzip:   0.95 kB │ map:     6.19 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-BjbJnPeU.js                           2.10 kB │ gzip:   0.95 kB │ map:     4.57 kB
../holdspeak/static/_built/assets/SetupCore-Bp4jQAtQ.js                                 2.21 kB │ gzip:   1.08 kB │ map:     8.65 kB
../holdspeak/static/_built/assets/CadenceCore-Cpt3PXpn.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-DyXZX4x1.js                              3.02 kB │ gzip:   1.39 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/CommandsCore-T1-XoZ1Q.js                              4.08 kB │ gzip:   1.73 kB │ map:    15.43 kB
../holdspeak/static/_built/assets/ProfilesCore-IV7o1Ltq.js                       
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T04:37:27Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py config`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9c9feebcd53b793be1245e7b869b89afbf8dd7ac
...
- **The root cause found:** the "unstyled selects" were the DESK'S OWN
  components — InlineEditor, DeliveryBoard, AttentionDrawer,
  RunsOnPicker, SessionPullout, PersonaChat, DeskToolShelf,
  DeskListView all shipped raw `<select>`/`<input>` elements that
  bypassed the Signal classes entirely.
- **The OS move:** bare `select`/`textarea`/text-like `input`
  elements inside `.desk-next` now INHERIT the Signal control
  foundation at zero specificity (no component can ship an unstyled
  control again), at the denser `--desk-control-h`; bare desk selects
  get the drawn chevron.
- **The finishing skin:** `<option>` popups on the surface tone;
  `accent-color` on checkboxes/radios; the date/time picker indicator
  inverted and hover-brightening; the search cancel glyph DRAWN via a
  currentColor mask (no native ✕); the file input's selector button a
  Signal face with hover. The gallery gains Date/Search/Number/File
  demos.
- **Live proof:** the `config` walk leg captured green — a real
  settings change round-trips byte-identically through the skinned
  controls.
- **Shots looked at:** the desk object editor pull-out
  ([assets/controls-editor-1440.png](./assets/controls-editor-1440.png)
  — also wearing the new HS-99-02 bar), Meetings filters (dates),
  Import (file), the gallery.
- **Suites:** captured `npm run check` green (290 web tests); token
  gate clean (the search-cancel mask carries no color — it paints
  with `background-color: var(--text-muted)`).

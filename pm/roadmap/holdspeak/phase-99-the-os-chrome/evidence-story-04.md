...
- **Story:** HS-99-04 - Scrollbars and menus
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T04:44:52Z

- **Command:** `bash -c cd web && npm run check`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 280e122989f2927a305344fdd71c96e8331c476e
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  22:44:57
   Duration  10.18s (transform 757ms, setup 1.39s, import 3.46s, tests 3.00s, environment 8.96s)
...
../holdspeak/static/_built/assets/desk-D1fZLg3M.css                                    66.79 kB │ gzip:  11.56 kB
../holdspeak/static/_built/assets/index-2EDhulde.css                                   99.97 kB │ gzip:  32.33 kB
../holdspeak/static/_built/assets/webworkerAll-D9NNYgbM.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-C1JWtfnQ.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-ec-KI9_y.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-CTJIKOCy.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-Cs8Jvquv.js                                0.99 kB │ gzip:   0.59 kB │ map:     2.65 kB
../holdspeak/static/_built/assets/pageSupport-C_c5vK9W.js                               1.01 kB │ gzip:   0.61 kB │ map:     5.63 kB
../holdspeak/static/_built/assets/CompanionCore-BwFiQE3y.js                             1.81 kB │ gzip:   0.95 kB │ map:     6.19 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-jCgQ0dPD.js                           2.10 kB │ gzip:   0.95 kB │ map:     4.57 kB
../holdspeak/static/_built/assets/SetupCore-Ch-3aO6Z.js                                 2.21 kB │ gzip:   1.08 kB │ map:     8.65 kB
../holdspeak/static/_built/assets/CadenceCore-DVTzO6VV.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-B4e9-zLa.js                              3.02 kB │ gzip:   1.39 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/CommandsCore-f-6oMd7Y.js                              4.08 kB │ gzip:   1.72 kB │ map:    15.43 kB
../holdspeak/static/_built/assets/ProfilesCore-B7t5lksg.js                       
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T04:45:11Z

- **Command:** `bash -c export HS_WALK_BASE=http://127.0.0.1:8797; uv run python scripts/desk_gl_walk.py windows 2>&1 | tail -1; uv run python scripts/desk_gl_walk.py shelf 2>&1 | tail -1`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 280e122989f2927a305344fdd71c96e8331c476e
...
- **Scrollbars belong to the OS:** a drawn 12px pill thumb
  (transparent-border + background-clip carve) on a transparent
  track, product-wide; hover brightens via the token pair. GOTCHA
  RECORDED: modern Chromium DISABLES `::-webkit-scrollbar` styling
  when the standard `scrollbar-width/color` properties are set — the
  standard pair now lives behind
  `@supports not selector(::-webkit-scrollbar)` (Firefox only). And
  the HEADLESS shell suppresses custom scrollbars entirely (gutter 0)
  — verification must be headed, like the storm; headed gutter
  measured 12px on the product
  ([assets/scrollbar-1440.png](./assets/scrollbar-1440.png)).
- **One menu vocabulary:** `DeskMenuList`/`DeskMenuItem`
  (web/src/desk/components/DeskMenu.tsx) carry the HS-96-05 keyboard
  pattern (roving arrows, Home/End, Escape with focus return), the
  transient material, and the anchor-corner squaring. All three desk
  popovers render through it: the room menu (refactored, classes and
  walk deps preserved), the HS-99-02 head menu, and the NEW dock chip
  right-click menu (Minimize/Restore + Close —
  [assets/dock-menu-1440.png](./assets/dock-menu-1440.png)), pinned
  by vitest.
- **Floors intact:** windows + shelf walk legs captured green on the
  production bundle.

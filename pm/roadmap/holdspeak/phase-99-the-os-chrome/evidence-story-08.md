...
- **Story:** HS-99-08 - Closeout: the chrome walk
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T04:59:55Z

- **Command:** `bash -c set -e; export HS_WALK_BASE=http://127.0.0.1:8797; for leg in smoke windows shell cores dictation meetings config lastexits reflow grammar surfaces chrome; do echo "=== leg: $leg"; uv run python scripts/desk_gl_walk.py $leg 2>&1 | tail -2; done; echo "=== storm"; uv run python scripts/desk_gl_walk.py storm --assembled 2>&1 | tail -1`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 462d6d07000f3e45bc8a2cecab69ccc82f9a8edc
...
=== storm
storm: {"gpu": "hardware", "frames": 964, "median_ms": 8.3, "p95_ms": 10.0, "max_ms": 10.4, "layout_events": 21, "paint_events": 644}
```

### Captured run — 2026-07-19T05:05:02Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  23:05:07
   Duration  10.54s (transform 769ms, setup 1.45s, import 3.65s, tests 2.96s, environment 9.35s)
...
../holdspeak/static/_built/assets/desk-DrfPeCxF.css                                    68.17 kB │ gzip:  11.74 kB
../holdspeak/static/_built/assets/index-2EDhulde.css                                   99.97 kB │ gzip:  32.33 kB
../holdspeak/static/_built/assets/webworkerAll-BvBKdAm7.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-DzhxWNmR.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-B7mhRLj6.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-ywa7EovB.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-RTZY7hM8.js                                0.99 kB │ gzip:   0.59 kB │ map:     2.65 kB
../holdspeak/static/_built/assets/pageSupport-C2a4YCfZ.js                               1.01 kB │ gzip:   0.61 kB │ map:     5.63 kB
../holdspeak/static/_built/assets/CompanionCore-BmSLUGIP.js                             1.81 kB │ gzip:   0.95 kB │ map:     6.19 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-Cx-2dysB.js                           2.10 kB │ gzip:   0.95 kB │ map:     4.57 kB
../holdspeak/static/_built/assets/SetupCore-DmF40cuv.js                                 2.21 kB │ gzip:   1.08 kB │ map:     8.65 kB
../holdspeak/static/_built/assets/CadenceCore-6XX_Uii8.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-CRdHt0xi.js                              3.02 kB │ gzip:   1.39 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/CommandsCore-DUZKLsD9.js                              4.08 kB │ gzip:   1.73 kB │ map:    15.43 kB
../holdspeak/static/_built/assets/ProfilesCore-DGEqqzKk.js                       
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T05:05:21Z
...
4114 passed, 37 skipped in 912.82s (0:15:12)
```

## Summary of proof — phase CLOSED 8/8

- **The chrome leg (new, HEADED):** mechanical asserts on the
  assembled chrome — the 40px bar with truly SQUARE full-height verbs
  (this leg caught the stale surface-window head override that kept
  the verbs at 26×19 after the eyeball had passed them — killed and
  re-proven), the red-hover close, the head menu (with the
  first-Escape-eats-the-menu contract), computed `appearance: none`
  on selects, the drawn scrollbar's 12px gutter, square corners on
  maximize, and the dock's running underline. Shots at 1440 and 393
  looked at ([assets/chrome-bar-1440.png](./assets/chrome-bar-1440.png),
  [assets/chrome-desk-1440.png](./assets/chrome-desk-1440.png),
  [assets/chrome-393.png](./assets/chrome-393.png)).
- **The assembled chain (captured, one run):** all twelve legs green —
  smoke, windows, shell, cores, dictation (real voice), meetings
  (real recording), config (round-trip persists), lastexits (15
  routes + workflow save), reflow, the six-leg grammar chain,
  surfaces (all 14 windows, zero page grammar), chrome — zero failed
  API responses. Storm assembled: 8.3ms median / 10.0 p95 / 10.4 max,
  21 layout events — the envelope holds with the blur, the underline,
  and the new bar live.
- **Suites (captured):** `npm run check` green (291 web tests, axe in
  suite); the full python sweep **4114 passed / 37 skipped / 0
  failed** (metal excluded per standing rule).
- **UAT:** `phase99.os.chrome` feature added; Campaign 13's
  design-polish scenario gains the bar/controls/scrollbar/dock steps;
  ledger regenerated; conductor pin at 100 since the scaffold.
- **Close:** final-summary.md records the riders (custom select
  popup, chip exit motion, theming seam, badges, submenus) and the
  handoffs (HSM One Grammar on Glass; The Living World).

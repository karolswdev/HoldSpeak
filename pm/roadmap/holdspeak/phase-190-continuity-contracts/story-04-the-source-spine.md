# HS-190-04 — The source spine: capture registry, outbox, observations

- **Project:** holdspeak
- **Phase:** 160
- **Status:** backlog
- **Depends on:** HS-190-01, HS-190-02
- **Unblocks:** HS-190-03, HS-190-07, HS-190-08, HS-190-09, HS-190-11
- **Owner:** unassigned
...
- [ ] Journal/observation rows store references, hashes, spans, and redacted
  ...
  the HS-190-06 `PrivateMaterialService` boundary.

# HS-190-06 — The private-material vault: custody and key saga

- **Project:** holdspeak
- **Phase:** 160
- **Status:** backlog
- **Depends on:** HS-190-01, HS-190-02, HS-190-03
- **Unblocks:** HS-190-05, HS-190-07, HS-190-08, HS-190-09
- **Owner:** unassigned
...
- **Out:** inventing cryptography, plaintext fallback, cloud key escrow,
  legacy inference-table cutover (HS-190-07), Remove/Forget orchestration
  (HS-190-08), arbitrary filesystem secure-erasure claims, and derivation.
...
- CF-0 INV-008/009 and §§12/15 are normative; HS-190-07/08 complete this

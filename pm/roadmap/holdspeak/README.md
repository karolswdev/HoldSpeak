...
| 32 | Foundation hardening & doc truth: class-ify `web_runtime.py`, invert the meeting→web-server coupling, converge audio ownership, add an ungated CI core-path smoke test, extract a route error helper, and reconcile stale non-PMO docs. Runs after Phase 31. | in-progress | [phase-32-foundation-hardening](./phase-32-foundation-hardening/) |

...
**Last updated:** 2026-06-01 (HS-30-01 shipped — **Phase 30 (UI/UX overhaul) opened, in-progress 1/9.** UX audit + IA spec landed: the Amiga Workbench look is being retired for "Signal" (bold, dark-only); 12 named problems, a grouped-nav IA that lifts Settings out of History, and "before" screenshots of all five routes. Design system derived with the vendored `ui-ux-pro-max` skill. Web build green).
**Current phase:** [phase-25-trust-and-hardening](./phase-25-trust-and-hardening/current-phase-status.md) — in-progress (HS-25-01..06 + 08 done; HS-25-07 hardware-blocked, author remote). Other open tracks: **Phase 30** (UI/UX overhaul → "Signal" dark identity, 1/9, in-progress); **Phase 24** (companion, 3/6; HS-24-01/02/06 done, HS-24-03/04/05 hardware-gated); **Phase 15** (out-and-about, `not-started`, gated on Phase 25). Next plugin work is the **frontier** (authoring guide / packs / actuators), not stubs — see Phase 29's `final-summary.md` §Handoff.

...
**Last updated:** 2026-06-01 (HS-30-02 shipped — **Phase 30 (UI/UX overhaul) in-progress 2/9.** The "Signal" design language is **signed off** (bold, dark-only: near-black surfaces, signature orange, Space Grotesk/Inter/JetBrains Mono, real depth) against a rendered preview; full AA contrast table + token-name map ready for the foundation rewrite. Earlier: HS-30-01 UX audit + IA spec (12 problems; Settings lifted out of History). Design system derived with the vendored `ui-ux-pro-max` skill. Web build green).
**Current phase:** [phase-25-trust-and-hardening](./phase-25-trust-and-hardening/current-phase-status.md) — in-progress (HS-25-01..06 + 08 done; HS-25-07 hardware-blocked, author remote). Other open tracks: **Phase 30** (UI/UX overhaul → "Signal" dark identity, 2/9, in-progress); **Phase 24** (companion, 3/6; HS-24-01/02/06 done, HS-24-03/04/05 hardware-gated); **Phase 15** (out-and-about, `not-started`, gated on Phase 25). Next plugin work is the **frontier** (authoring guide / packs / actuators), not stubs — see Phase 29's `final-summary.md` §Handoff.

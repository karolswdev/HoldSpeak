...
| Transient "MEETING READY · N open · 0 decided" toast: a zero count (`AmbientLayer.tsx:175`, `intelligenceAttention.ts:95-96`) breaks UX-CANON A.8; at 393 the toast covers the summary text and the capture bar (`final/…/shots/summary/393-after.png`). Omit zero tokens; no overlap; rendered transition proof. | UX-CANON A.8; the no-overlap rule | ledger row 4 | product follow-up owed |

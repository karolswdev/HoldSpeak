...
| E | `WebRuntime` / `web_server` decomposition (+ `meeting_session.py`) | debt | review "Trouble" #1 | **scaffolded → [phase-63](./phase-63-backend-decomposition/)** on owner direction ("E, puh-lease"); web_server already thin (P26/P34), the targets are web_runtime.py (2,635 — regrown past pre-P52) + meeting_session.py (1,674) |

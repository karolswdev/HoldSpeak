...
|----|-------|--------|------------|----------|
| HS-129-01 | The foot slot — one window anatomy | ready | [story-01](story-01-the-foot-slot.md) | — |
...
| HS-129-07 | The speakable desk | backlog | [story-07](story-07-the-speakable-desk.md) | — |
...
Chartered from a four-audit evidence base. HS-129-01 (the foot slot) is the
keystone: it fixes the owner's two screenshots (floating Settings footer,
parking Speak strip) at the architectural seam and unblocks 02–05. Stories
06–10 are parallel planes; 11 is the non-waivable exit walk.

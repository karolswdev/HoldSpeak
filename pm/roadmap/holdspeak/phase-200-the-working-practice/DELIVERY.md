...
| **G2: Configurable working practice** | 17–23 | Three recipes, replay-safe setup, revisit, one actual scheduled brief, and the R1 pilot pass. **G2 cannot close before HS-200-53 (G4) lands:** story 21's actual-scheduled-brief leg is proven there, because the cron clock cannot serve a practice recipe until HS-200-47–51 repair it (ruled 2026-09-18 by the orchestrator; 21 is not re-gated). | Useful daily work and its supported recurrence are demonstrated. |

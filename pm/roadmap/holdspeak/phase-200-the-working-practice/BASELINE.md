...
| Meeting outcomes | Meeting completion, proposal bridge, decisions, follow-through | Reuse; prove one production chain in 12–14 and 16. Decision supersession exists; the accept and reject verbs exist on the decisions routes (holdspeak/web/routes/decisions.py:57,61) — corrected 2026-09-07 by counsel's read of HS-200-09; what is missing is the claim-axis drop to LINKED · EDITED on confirm (story 12). |

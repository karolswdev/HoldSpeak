...
- **Story:** HS-98-01 - The surface idiom
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T00:34:49Z

- **Command:** `uv run pytest -q tests/unit/test_native_surfaces_guard.py tests/unit/test_page_cores_guard.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** be8552416d633b7c8b1b5c38af1b3013e6b5e121
...
### Captured run — 2026-07-19T00:34:59Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  18:35:04
   Duration  10.08s (transform 766ms, setup 1.41s, import 3.52s, tests 2.74s, environment 8.99s)
...
../holdspeak/static/_built/assets/CadenceCore-I82HMIUQ.css                              4.38 kB │ gzip:   1.19 kB
../holdspeak/static/_built/assets/desk-BVYW4b5r.css                                    65.58 kB │ gzip:  11.31 kB
../holdspeak/static/_built/assets/index-Ce_6bimw.css                                  102.86 kB │ gzip:  32.80 kB
../holdspeak/static/_built/assets/webworkerAll-DhpKbFdB.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-DO-NcUXL.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-UYo5joP0.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-aYyO3IKT.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-CEvML1RK.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-Po-c1udT.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-BjUENaG8.js                             2.13 kB │ gzip:   1.01 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-BT3rGdSB.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/SetupCore-yD5y4HR1.js                                 2.39 kB │ gzip:   1.09 kB │ map:     8.29 kB
../holdspeak/static/_built/assets/ActivityCore-DrFHl8xU.js                              3.31 kB │ gzip:   1.46 kB │ map:    12.61 kB
../holdspeak/static/_built/assets/ComponentsCore-BITWImGh.js                            4.03 kB │ gzip:   1.57 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-BCfHNWm1.js                              4.22 kB │ gzip:   1.78 kB │ map:    15.52 kB
../holdspeak/static/_built/assets/ProfilesCore-B9qSfTKA.js                       
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T00:35:34Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py reflow`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** be8552416d633b7c8b1b5c38af1b3013e6b5e121
...
- **Spec first:** `docs/internal/DESIGN_SYSTEM.md` gains "The surface
  idiom (HS-98)" — six rules in token vocabulary, the 560px container
  breakpoint recorded as canon (container queries cannot read custom
  properties).
- **Tokens:** seven `--desk-surface-*` density tokens (row height,
  paddings, gaps, three type sizes) in `web/design-tokens.json`;
  generated CSS/TS in sync (`tokens:check` inside the captured
  `npm run check`); token gate clean with NO new allow-list entries.
- **Kit:** `web/src/desk/surface/` — `SurfaceVerbs` (one sticky verb
  bar), `SurfaceSection` (hairline + quiet label), `SurfaceRows`/
  `SurfaceRow` (dense rows, revealed verbs), `SurfaceState` (one
  loading/error/empty treatment), `SurfaceColumns` + `SurfaceSplit`
  (@container reflow), `MetricStrip` (omits empty figures),
  `ConfirmVerb` (inline two-step, no modal), and `format.ts`
  (`humanTime`/`deSnake`/`presentValue`). `.desk-surface-body` is the
  `surface` size container in desk.css.
- **Seam guard:** `tests/unit/test_native_surfaces_guard.py` — page
  grammar forbidden in cores; allowlist seeded at the 2026-07-18 truth,
  stale entries fail (shrink-only), plant test proves the scanner
  fires; kit CSS refused viewport width media queries.
- **Reference core:** CadenceCore converted end to end — zero
  forbidden tokens (absent from the allowlist), modal ConfirmAction
  replaced by inline ConfirmVerb, loops/history as honest rows.
- **Reflow, live:** the `reflow` walk leg (captured above) on the
  production bundle against the staged hub on :8797 — one 1440
  viewport, the Cadence window side-by-side at its default width,
  STACKED after dragging the window's right edge past the breakpoint,
  zero failed API responses, zero page grammar in the live DOM. Shots
  looked at: [assets/reflow-wide-1440.png](./assets/reflow-wide-1440.png),
  [assets/reflow-narrow-1440.png](./assets/reflow-narrow-1440.png).
- **Suites:** captured runs above — seam+cores guards 6 passed;
  `npm run check` green (typecheck, 288 web tests incl. 9 new kit
  tests, tokens gates, architecture guard, build); the full python
  sweep (metal excluded) captured below.

### Captured run — 2026-07-19T00:35:47Z
...
.............................................                            [100%]
=================================== FAILURES ===================================
_____________________________ test_features_route ______________________________

client = <starlette.testclient.TestClient object at 0x14d9c33f0>
    ...
    def test_features_route(client):
        ...
        # Phase numbers are zero-based in the record: 0 through 98 is 99 phases.
>       assert body["phases_total"] == 99
E       assert 98 == 99

tests/uat/test_conductor_api.py:96: AssertionError
=============================== warnings summary ===============================
tests/integration/test_web_transcript_import_api.py::test_txt_upload_uses_the_transcript_fallback_speaker
  /Users/karol/dev/tools/HoldSpeak/.venv/lib/python3.13/site-packages/_pytest/threadexception.py:58: PytestUnhandledThreadExceptionWarning: Exception in thread meeting-import-e2d4c67d
...
FAILED tests/uat/test_conductor_api.py::test_features_route - assert 98 == 99
1 failed, 4113 passed, 37 skipped, 1 warning in 906.98s (0:15:06)
```

### Captured run — 2026-07-19T00:52:06Z

- **Command:** `uv run pytest -q tests/uat/test_conductor_api.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** be8552416d633b7c8b1b5c38af1b3013e6b5e121
...
The full sweep above landed 4113 passed / 37 skipped with ONE failure:
`test_conductor_api.py::test_features_route` asserting the bumped 99
while the ledger still said 98 — the phase-index table in the roadmap
README had no Phase 98 row, so `build_ledger` never counted it. Row
added, ledger regenerated (`phases_total: 99`), and the conductor suite
re-captured green above (12 passed).

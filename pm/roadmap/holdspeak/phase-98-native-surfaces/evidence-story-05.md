...
- **Story:** HS-98-05 - The config pair
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T01:15:55Z

- **Command:** `uv run pytest -q tests/unit/test_native_surfaces_guard.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9a89d28ac24b8386fd0e09ad9147e47dd771a320
...
### Captured run — 2026-07-19T01:15:56Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  19:16:00
   Duration  9.77s (transform 671ms, setup 1.36s, import 3.29s, tests 2.75s, environment 8.71s)
...
../holdspeak/static/_built/assets/webworkerAll-BasYWPJg.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-CybHV50E.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-C0ZVS-p6.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-D9qLWcUp.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-Ck047J5a.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-DJ19Hi7V.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-DxmowKcZ.js                             2.13 kB │ gzip:   1.01 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/SetupCore-GEHwzIB4.js                                 2.21 kB │ gzip:   1.08 kB │ map:     8.65 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-DuYtBKfK.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/CadenceCore-DTItUNG7.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-BSnlfE48.js                              3.02 kB │ gzip:   1.39 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/ComponentsCore-91NYJRjS.js                            4.03 kB │ gzip:   1.58 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-DsYnvnsn.js                        
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T01:16:13Z
...
- **SettingsCore (557 → native):** the three panels became surface
  sections on the material (Control posture, Hub configuration,
  Credentials); Save on the verb bar; the recursive `SettingsFields`
  editor unchanged (Signal controls are token-native); secret Rotate
  and Delete are inline two-steps now; the Integrations alias scrolls
  the Credentials section into view on scoped open (ref-based — no
  querySelector).
- **SetupCore (164 → native):** verb bar with the honest overall pill
  and Test runtime/Refresh; readiness checks as honest rows;
  next-step column.
- **Guard:** both cores OFF the allowlist (captured pytest); six
  cores remain on the shrinking ledger.
- **Live proof:** the `config` walk leg captured above — a real
  settings change round-trips and PERSISTS byte-identically through
  the NEW editor; runs-on/cadence/integrations open in-world; the
  Integrations alias lands scoped (chip shot in config-1440.png);
  deep links land in-world.
- **Shots looked at:** [assets/settings-1440.png](./assets/settings-1440.png),
  [assets/setup-1440.png](./assets/setup-1440.png),
  [assets/config-1440.png](./assets/config-1440.png).

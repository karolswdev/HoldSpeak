...
- **Story:** HS-98-03 - Meetings, native
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T01:06:13Z

- **Command:** `uv run pytest -q tests/unit/test_native_surfaces_guard.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9f2c3720004a8d8249af8aae52240ae4380f1ee2
...
### Captured run — 2026-07-19T01:06:14Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  19:06:18
   Duration  9.95s (transform 707ms, setup 1.37s, import 3.28s, tests 2.78s, environment 8.84s)
...
../holdspeak/static/_built/assets/webworkerAll-DKNzJmZr.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-BcAB5_zk.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-DQVpGosC.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-DiRNFok-.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-BfihpS-x.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-C6U-ibej.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-ROXZ0Qo7.js                             2.13 kB │ gzip:   1.02 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-CKmCn-53.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/SetupCore-PhF8zDFQ.js                                 2.39 kB │ gzip:   1.09 kB │ map:     8.29 kB
../holdspeak/static/_built/assets/CadenceCore-D3pOWq-_.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-CZp3Oz_7.js                              3.31 kB │ gzip:   1.47 kB │ map:    12.61 kB
../holdspeak/static/_built/assets/ComponentsCore-BkaGSA_T.js                            4.03 kB │ gzip:   1.58 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-B8jguZG1.js                        
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T01:06:32Z
...
- **HistoryCore (933 → native):** the meeting DETAIL left its modal —
  it is now the SurfaceSplit's second pane beside the archive (wide:
  two panes; narrow window: the detail replaces the archive), with its
  own quiet section head and Close verb. Import left its modal too (an
  in-surface section under the verb bar). The archive is honest rows
  (title, humanized when, state pill; row body = one press target,
  selected row wears the accent tint); filters fold into a quiet
  Disclosure; delete-meeting is an inline two-step. Artifacts render
  behind Disclosures as SurfaceCode; aftercare/proposals are surface
  rows with their approve/reject/slack verbs intact. Wire calls
  unchanged.
- **Guard:** HistoryCore OFF the allowlist (captured pytest).
- **Live proof:** the `meetings` walk leg captured above — record →
  stop → pull-out → "Review meeting" scoped IN the window (the leg's
  detail wait now accepts the kit's `.surface-state` beside
  `.transcript-list`/`.signal-empty`) → deep links. One real meeting
  recorded against the staged hub.
- **Shots looked at:** archive + open detail split at 1440, archive
  sheet at 393 ([assets/meet-archive-1440.png](./assets/meet-archive-1440.png),
  [assets/meet-detail-1440.png](./assets/meet-detail-1440.png),
  [assets/meet-archive-393.png](./assets/meet-archive-393.png)). The
  detail shot drove one more quieting: Disclosures inside surfaces
  drop their boxed card (transparent, hover wash), and the transcript
  list is restyled dense on the material (class name kept — walk
  canon).

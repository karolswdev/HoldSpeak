...
- **Story:** HS-98-04 - The live pair
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T01:11:58Z

- **Command:** `uv run pytest -q tests/unit/test_native_surfaces_guard.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** dd1aba99f79e1553704a02dc5e5863e827bab860
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  19:12:02
   Duration  9.70s (transform 693ms, setup 1.31s, import 3.26s, tests 2.78s, environment 8.60s)
...
../holdspeak/static/_built/assets/Surface-D-JktPLn.css                                  6.51 kB │ gzip:   1.51 kB
...
../holdspeak/static/_built/assets/webworkerAll-0k2OCBP2.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-DbRTEYU6.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-BTi352HC.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-ESrJ1JK6.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-COUS1yY0.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-BBzvFTPI.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-DpnchEUg.js                             2.13 kB │ gzip:   1.01 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-CCl0YkUD.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/SetupCore-ChezF0cO.js                                 2.39 kB │ gzip:   1.09 kB │ map:     8.29 kB
../holdspeak/static/_built/assets/CadenceCore-DoPejfgS.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-DEFevVKQ.js                              3.02 kB │ gzip:   1.39 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/ComponentsCore-C3ps5Uzq.js                            4.03 kB │ gzip:   1.58 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-C5KlMYRF.js                        
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T01:12:16Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py meetings`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** dd1aba99f79e1553704a02dc5e5863e827bab860
...
### Captured run — 2026-07-19T01:12:30Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py cores`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** dd1aba99f79e1553704a02dc5e5863e827bab860
...
- **LiveCore (460 → native):** verb bar with the honest room status
  (title, else Recording/Ready to record) and the Start/Stop primary;
  a quiet MetricStrip (connection, duration, segments, room); the
  transcript as the split's main pane with the meeting-details MODAL
  now an inline block under the section head; bookmark + intelligence
  as the collapsing rail; intent routing + deferred jobs as columns
  (the jobs JSON dump now honest SurfaceFacts); devices as honest rows
  — absent battery/RSSI values are OMITTED, never "— %".
- **ActivityCore (257 → native):** verb bar (Refresh + Watching
  switch), one section with tabs/filter, honest rows with humanized
  times and per-tab verbs; Clear records and rule Delete are inline
  two-steps (modal gone).
- **Two defects the live shot caught, fixed:** `[object Object]`
  rendered beside the intelligence pill (an object egress value now
  presents its label or falls to "This device"), and the status read
  "Ready to record" mid-recording.
- **Guard:** both cores OFF the allowlist (captured pytest).
- **Live proof:** the `meetings` leg (drives the NEW LiveCore's
  Start/Stop through a real recording) and the `cores` leg (opens the
  NEW ActivityCore in-world, asserts chrome-free) captured above.
- **Shots looked at:** [assets/live-recording-1440.png](./assets/live-recording-1440.png),
  [assets/activity-1440.png](./assets/activity-1440.png).
- **Suites:** captured `npm run check` green (289 web tests; the
  cores test now asserts the surface verb bar).

...
- **Story:** HS-98-06 - The builder set
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T01:20:36Z

- **Command:** `uv run pytest -q tests/unit/test_native_surfaces_guard.py`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 3eea78bcc523149f6e395024fa92ee959c508407
...
### Captured run — 2026-07-19T01:20:37Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  19:20:41
   Duration  9.59s (transform 691ms, setup 1.28s, import 3.26s, tests 2.74s, environment 8.47s)
...
../holdspeak/static/_built/assets/webworkerAll-BbiDNyXU.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-Nb3OkBTx.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-664I1qT9.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-CF-sVv6h.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-6GLQdK42.js                                0.99 kB │ gzip:   0.59 kB │ map:     2.65 kB
../holdspeak/static/_built/assets/pageSupport-BfckF2Mr.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-Dszi40uo.js                             2.13 kB │ gzip:   1.01 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/SetupCore-D5ZyQvxc.js                                 2.21 kB │ gzip:   1.08 kB │ map:     8.65 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-G4uV9-3f.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/CadenceCore-CUOn6hFm.js                               2.81 kB │ gzip:   1.33 kB │ map:    11.43 kB
../holdspeak/static/_built/assets/ActivityCore-MpiYj6-p.js                              3.02 kB │ gzip:   1.38 kB │ map:    12.16 kB
../holdspeak/static/_built/assets/ComponentsCore-DWi5YieK.js                            4.22 kB │ gzip:   1.70 kB │ map:    12.09 kB
../holdspeak/static/_built/assets/CommandsCore-BO_JwN7e.js                        
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-19T01:20:54Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py lastexits`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 3eea78bcc523149f6e395024fa92ee959c508407
...
- **WorkbenchCore (448 → native):** the node canvas untouched; the
  inspector left its Signal Panel for a `surface-float` (the one
  window material at transient elevation, quiet head + Close); preset
  verbs ride the verb bar; "Run and return" is a section with the run
  output as SurfaceCode; save/run/return verbs in one quiet cluster.
- **StudioCore (60 → native):** launcher cards became dense launcher
  ROWS (glyph + title + purpose, whole row a press target).
- **ComponentsCore (184 → native):** the gallery now demonstrates the
  CURRENT canon — Signal controls composed on surface sections/
  columns, plus a new "Rows, states, and the two-step" section
  (honest row, press-target row, ConfirmVerb firing with NO modal, the
  quiet empty state). The Dialog demo left with the grammar it
  demonstrated.
- **Guard:** three cores OFF the allowlist (captured pytest); four
  remain.
- **Live proof:** the `lastexits` leg captured above — all 15 demoted
  routes land on the desk with the right window; Workbench opens
  maximized from the shelf and SAVES a real workflow through the new
  chrome ("Save Workflow"); companion window opens.
- **Shots looked at:** [assets/workbench-1440.png](./assets/workbench-1440.png)
  (inspector float on the material beside live cables),
  [assets/studio-1440.png](./assets/studio-1440.png),
  [assets/components-1440.png](./assets/components-1440.png).

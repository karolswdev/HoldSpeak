...
- **Story:** HS-98-08 - The surface floors, written
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-19T01:31:59Z

- **Command:** `uv run pytest -q tests/unit -k doc or design or voice or guard`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 64e8cacf72f9c26c4df25ecdf738b08cc74065d8

```text
........................................................................ [ 37%]
........................................................................ [ 74%]
..................................................                       [100%]
194 passed, 3014 deselected in 2.46s
```

### Captured run — 2026-07-19T01:32:02Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  44 passed (44)
   ...
   Start at  19:32:07
   Duration  10.12s (transform 717ms, setup 1.39s, import 3.53s, tests 2.82s, environment 8.96s)
...
- **DESIGN_SYSTEM.md:** "The surface idiom (HS-98)" is now an Article
  VIII floors chapter — the six rules bind like the physics floors,
  the closed ledger is recorded, and the proof legs (`reflow`,
  `surfaces`) are named.
- **web/README.md:** the add-a-surface path's style step is now
  "Compose the surface kit" — every kit piece named with its rule, the
  page grammar named as forbidden, the guard named as the lock.
- **ARCHITECTURE_WEB_FRONTEND.md:** the mechanical-locks list carries
  the Phase 98 surface-idiom lock beside the Phase 96 gates and the
  Phase 97 floors.
- **Guards:** 194 doc/design/guard tests green (captured); `npm run
  check` green (captured, 289 web tests).

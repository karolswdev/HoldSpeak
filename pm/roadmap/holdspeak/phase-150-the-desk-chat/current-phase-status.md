...
**Status:** building (4/8). Design-beat counsel RATIFY-WITH-CONCERNS;
...
| HS-150-05 | The Thread on the Desk (primitive, verbs, ThreadPullout, streaming renderer) | in-progress | [story-05](./story-05-thread-pullout.md) | - |

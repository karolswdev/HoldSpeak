...
- **Story:** HS-97-01 - The shadow returns
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-18T21:26:58Z

- **Command:** `bash -c cd web && python3 -c "
import json, shutil
shutil.copy(\"design-tokens.json\", \"/tmp/dt.bak.json\")
d = json.load(open(\"design-tokens.json\"))
d[\"component\"][\"groups\"].append({\"name\": \"--plant-unknown\", \"value\": \"0 1px 2px {primitive.color.shadow.nope}\"})
json.dump(d, open(\"design-tokens.json\", \"w\"), indent=2)
" && (node scripts/generate-tokens.cjs 2>&1 | grep -m1 "Error:"; true) && cp /tmp/dt.bak.json design-tokens.json && node scripts/generate-tokens.cjs --check`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** e0af9e74f3db91aa84b367a4d7fce93ef040fb30

```text
Error: unresolved token reference: {primitive.color.shadow.nope}
tokens.css and tokens.gen.ts match design-tokens.json
```

### Captured run — 2026-07-18T21:27:06Z
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  43 passed (43)
   ...
   Start at  15:27:11
   Duration  9.68s (transform 687ms, setup 1.33s, import 3.35s, tests 2.61s, environment 8.50s)
...
../holdspeak/static/_built/assets/desk-CIsdk7yN.css                                    63.08 kB │ gzip:  10.87 kB
../holdspeak/static/_built/assets/index-Dc0iPEA9.css                                  102.50 kB │ gzip:  32.70 kB
../holdspeak/static/_built/assets/webworkerAll-DpCMJirZ.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-DLmg3m7s.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-Cz_hK3DC.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-f_3JO_4j.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-DpJVrqdo.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-BfF3WxF6.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-Ck9Tol3V.js                             2.13 kB │ gzip:   1.02 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-Bw-r9RMT.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/SetupCore-Db03Cm51.js                                 2.39 kB │ gzip:   1.09 kB │ map:     8.29 kB
../holdspeak/static/_built/assets/ActivityCore-pQnRAEEN.js                              3.31 kB │ gzip:   1.47 kB │ map:    12.61 kB
../holdspeak/static/_built/assets/CadenceCore-Cr6jvn2z.js                               3.38 kB │ gzip:   1.49 kB │ map:    11.54 kB
../holdspeak/static/_built/assets/ComponentsCore-BsArRtJa.js                            4.03 kB │ gzip:   1.58 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-B050mbEG.js                              4.22 kB │ gzip:   1.79 kB │ map:    15.52 kB
../holdspeak/static/_built/assets/ProfilesCore-B4LbD_5U.js   
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-18T21:28:13Z

- **Command:** `uv run python /private/tmp/claude-501/-Users-karol-dev-tools-HoldSpeak/8bd47683-64cd-4ae5-9bee-f7376094a402/scratchpad/shot_shadows.py pm/roadmap/holdspeak/phase-97-the-window-grammar/assets`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** e0af9e74f3db91aa84b367a4d7fce93ef040fb30

```text
computed box-shadow: rgba(0, 0, 0, 0.6) 0px 26px 70px 0px
done
```

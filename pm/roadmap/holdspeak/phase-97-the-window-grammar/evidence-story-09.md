...
- **Story:** HS-97-09 - Closeout: the grammar walk
- **Status:** done
- **Date:** 2026-07-18

## Proof

### Captured run — 2026-07-18T23:49:31Z

- **Command:** `bash -c cd web && npm run check`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9631bdddf18ce6ff38c0973c34a27423d1faeffa
...
React architecture guard passed (143 source files; zero framework residue).
...
Error: Not implemented: HTMLCanvasElement.prototype.getContext (without installing the canvas npm package)
 ...
 Test Files  43 passed (43)
   ...
   Start at  17:49:36
   Duration  9.70s (transform 707ms, setup 1.35s, import 3.37s, tests 2.66s, environment 8.55s)
...
../holdspeak/static/_built/assets/desk-Bza0XaCc.css                                    65.50 kB │ gzip:  11.28 kB
../holdspeak/static/_built/assets/index-j6zS0IIN.css                                  102.64 kB │ gzip:  32.74 kB
../holdspeak/static/_built/assets/webworkerAll-_icPwq0E.js                              0.16 kB │ gzip:   0.16 kB │ map:     0.66 kB
../holdspeak/static/_built/assets/browserAll-BRdC1lwO.js                                0.25 kB │ gzip:   0.20 kB │ map:     1.67 kB
../holdspeak/static/_built/assets/WelcomePage-B_96ILn3.js                               0.43 kB │ gzip:   0.31 kB │ map:     1.13 kB
../holdspeak/static/_built/assets/PresencePage-NXnHn5Hx.js                              0.89 kB │ gzip:   0.52 kB │ map:     2.46 kB
../holdspeak/static/_built/assets/StudioCore-C9BgOR7d.js                                1.15 kB │ gzip:   0.62 kB │ map:     2.78 kB
../holdspeak/static/_built/assets/pageSupport-BZ7ha9T6.js                               1.68 kB │ gzip:   0.90 kB │ map:     6.56 kB
../holdspeak/static/_built/assets/CompanionCore-Vf4fZ8bI.js                             2.13 kB │ gzip:   1.02 kB │ map:     6.69 kB
../holdspeak/static/_built/assets/RuntimeDocsCore-C8flptGN.js                           2.24 kB │ gzip:   0.96 kB │ map:     4.70 kB
../holdspeak/static/_built/assets/SetupCore-ylkk8Y0C.js                                 2.39 kB │ gzip:   1.09 kB │ map:     8.29 kB
../holdspeak/static/_built/assets/ActivityCore-C9XpMAZI.js                              3.31 kB │ gzip:   1.47 kB │ map:    12.61 kB
../holdspeak/static/_built/assets/CadenceCore-SfnUBRiI.js                               3.38 kB │ gzip:   1.49 kB │ map:    11.54 kB
../holdspeak/static/_built/assets/ComponentsCore-XeAjrKxq.js                            4.03 kB │ gzip:   1.57 kB │ map:    10.39 kB
../holdspeak/static/_built/assets/CommandsCore-DcFVTGhA.js                              4.22 kB │ gzip:   1.78 kB │ map:    15.52 kB
../holdspeak/static/_built/assets/ProfilesCore-CSjoJgtq.js   
[PMO_EVIDENCE_OUTPUT_TRUNCATED]
```

### Captured run — 2026-07-18T23:49:56Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py closeout`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9631bdddf18ce6ff38c0973c34a27423d1faeffa
...
arrangement walk 1440: order+rects+max survive reload byte-identically, front=Settings, menu styled {'bg': 'rgba(0, 0, 0, 0)', 'align': 'left', 'border': 'none'}
arrangement walk 393: sheet action row tappable [{'label': 'Skip remaining', 'hittable': True}, {'label': 'Dictate about this', 'hittable': True}, {'label': 'Record follow-up', 'hittable': True}]
...
switcher walk: expose fans 3 (1 dim), click focuses, Escape cancels, the strip names all with the target and fades
shelf walk 1440: one centered dock (launchers + orb), pills gone, launcher folds into chip, no eyebrows, no stage prose
shelf walk 393: quiet chrome holds on the phone
grammar walk: all six grammar legs green
shot closeout-desktop-1440.png  api-failures=[]
shot closeout-phone-393.png  api-failures=[]
closeout walk: all walks green; final shots archived
```

### Captured run — 2026-07-18T23:53:20Z

- **Command:** `env HS_WALK_BASE=http://127.0.0.1:8797 uv run python scripts/desk_gl_walk.py storm --assembled`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9631bdddf18ce6ff38c0973c34a27423d1faeffa

```text
storm: {"gpu": "hardware", "frames": 962, "median_ms": 8.3, "p95_ms": 9.0, "max_ms": 9.3, "layout_events": 27, "paint_events": 772}
```

### Captured run — 2026-07-18T23:53:35Z

- **Command:** `bash -c tail -1 /tmp/hs97-09-sweep.log && cat /tmp/hs97-09-sweep.done && grep -q "exit=0" /tmp/hs97-09-sweep.done`
- **Cwd:** .
- **Exit code:** 0
- **Index-tree:** 9631bdddf18ce6ff38c0973c34a27423d1faeffa

```text
4110 passed, 37 skipped in 900.64s (0:15:00)
exit=0
```

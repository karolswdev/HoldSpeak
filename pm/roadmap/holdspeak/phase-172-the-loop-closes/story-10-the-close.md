...
- **Phase:** 172
- **Status:** backlog
- **Depends on:** HS-172-09
- **Unblocks:** Phase 173
- **Owner:** unassigned

## Problem

Phase 172 must close cleanly: all exit criteria checked, the full suite
...
- In:
  ...
  - The final summary written
    (phase-172-the-loop-closes/final-summary.md).
  - The PR opened; the owner's word to merge.
  - The hygiene lane items this phase's tree touches are paid (from
    THE-TUESDAY-ARC.md section 4).
- Out:

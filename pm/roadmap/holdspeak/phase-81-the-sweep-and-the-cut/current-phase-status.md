...
**Last updated:** 2026-07-04 (opened: the handover's ranked items 1 + 3 composed
into one phase — sweep the recorded run's small findings, then prep the v0.4.0
cut on an honest record. The tag stays the owner's button, Phase-65 rule.)
...
|---|---|---|---|
| HS-81-01 | F-10: the empty-input guard in `ProjectRewriter` — **leads** | todo | none |
...
Opened. The survey is done and every finding has a named fix site; the sweep
starts with the one MED (F-10).

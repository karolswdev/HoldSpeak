...
- **Story:** HS-151-02 - The capability (chat.turn sealed + assigned)
- **Status:** done
- **Date:** 2026-08-29
...
`test_hs151_chat_capability.py` (9), `test_mcp_tools.py`, and
...
Skips carry `HS-151-02` in their reason; 04 rewires or deletes them.

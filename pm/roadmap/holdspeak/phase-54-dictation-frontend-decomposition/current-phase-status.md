...
ways (a 500-line pad fires the guard with the actionable message; revert is green).
Full suite **2545 passed, 17 skipped** (the five guard tests are the +5).
**HS-54-03 (prior): the page is carved.** The 3,131-line

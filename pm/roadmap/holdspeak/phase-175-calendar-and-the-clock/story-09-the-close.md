...
- **Phase:** 175
- **Status:** backlog
- **Depends on:** HS-175-08
- **Unblocks:** Phase 176
- **Owner:** unassigned

## Problem

Phase 175 must close cleanly: all exit criteria checked, the full suite
...
- In:
  ...
  - The final summary written (phase-175-calendar-and-the-clock/final-summary.md).

...
OUTCOME: The ratified placement is built and the six actual surface walks pass. Story verification is complete; the lane is prepared for gated publication to main by PR. No merge is authorized. The actual calling Muad'Dib's counsel on the built PR remains before merge; any Astra-invoked Claude check is labelled separately.

...
Routes: 230 (plus static mounts). iOS-consumed: 44. Web-consumed: 160.
...
| POST | `/api/dictation/preview/discard` | server only |
| POST | `/api/dictation/preview/type` | server only |

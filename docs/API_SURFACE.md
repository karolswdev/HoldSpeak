...
Routes: 694 (plus static mounts). iOS-consumed: 89. Web-consumed: 526.
...
| GET | `/api/automations/practice-recipes` | web |
| GET | `/api/automations/practice-recipes/{recipe_id}` | server only |
| GET | `/api/automations/practice-recipes/{recipe_id}/plan` | server only |
...
| POST | `/api/concierge/summary-selection` | web |
...
| POST | `/api/decision-records/{record_id}/carry` | web |
| POST | `/api/decision-records/{record_id}/dispute` | server only |
| POST | `/api/decision-records/{record_id}/supersede` | server only |
...
| GET | `/api/meetings/{meeting_id}/outcome-review` | web |
...
| GET | `/api/threads/{thread_id}/interview/promotions` | server only |

...
from .models import (  # dataclasses + constants moved out in HS-31-01
...
class MeetingDatabase:
    ...
    def __init__(self, db_path: Optional[Path] = None):
        ...
        self._ensure_schema()
        self.meetings = MeetingRepository(self._connection)
    ...
    def requeue_intel_job(self, meeting_id: str, *, reason: Optional[str] = None) -> bool:
        ...
        meeting = self.meetings.get_meeting(meeting_id)

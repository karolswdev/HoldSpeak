...
from .models import (
    ...
    VALID_ACTION_ITEM_REVIEW_STATES,
)

if TYPE_CHECKING:  # forward-ref types for annotations (imported lazily at runtime)
    from ..meeting_session import MeetingState, TranscriptSegment, IntelSnapshot
...
class MeetingRepository(BaseRepository):
    ...
    def _row_to_meeting_state(
        ...
        from ..meeting_session import MeetingState, TranscriptSegment, Bookmark

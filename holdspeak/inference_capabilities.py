...
def builtin_capability_definitions() -> tuple[InferenceCapabilityDefinition, ...]:
    ...
    return (
        ...
        _capability("chat.compact", "Chat compaction", *thought, "Summarize a chat thread prefix for compaction.", operation="chat.compact", output_kind="compaction_summary", structured_output=True, minimum_context_tokens=4096, policy="retry.structured.standard", fallback_dispositions=structured_fallback, source_module="holdspeak.services.thread_practice"),

        ...
        *,
        ...
        try:
            session = MeetingSession(
                ...
                on_mic_level=lambda level: self._emit_audio_level(level, "meeting_mic"),
                on_system_level=lambda level: self._emit_audio_level(level, "meeting_system"),
                ...
                cloud_reasoning_effort=self.config.meeting.intel_cloud_reasoning_effort,
                cloud_store=self.config.meeting.intel_cloud_store,

...
One public constructor, unchanged: ``build_system_router`` includes the five
single-concern routers (health, the coder board, settings, the voice lane,
the /ws socket). Bodies moved verbatim from the 1,299-line routes/system.py.
"""

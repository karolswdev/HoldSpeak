...
# HS-134-08: migrate_routing_profile deleted (pre-release cleanup).
# The legacy `mir_profile` / `plugin_profile` keys no longer exist on
# MeetingConfig; _coerce drops them on load with a warning, so existing
